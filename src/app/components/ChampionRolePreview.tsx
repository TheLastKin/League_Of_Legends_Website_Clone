...
const ChampionRolePreview = () => {
    ...
    const onRoleClicked = (index: number) => () => {
        ...
        background.style.backgroundImage = `linear-gradient(to bottom, rgba(255, 255, 255, 0.9), rgba(255, 255, 255, 0.9)), url("/image/${champions[index].role}_icon_gray.jpg")`
        ...
        introBack.src = `/video/Class_Intro_Video_${index + 1}.webm`;
                ...
                <div className="champion_roles">
                    <span className="line">
                        ...
                        <div className="champion_preview_video">
                            <span></span>
                            <video id='class_intro_video_front' src="/video/Class_Intro_Video_1.webm" autoPlay muted loop></video>
                            <video id='class_intro_video_back' src="/video/Class_Intro_Video_2.webm" autoPlay muted loop></video>
                        </div>
                    </span>
                </div>
                <div className="animated_circle">
                    {
                        champions.map((champion, index) => (
                            <img src={`/image/Champion_${champion.name}.png`} alt="" />
                        ))
                    }
