...
const ChampionSkin = () => {
    ...
    const changeSkin = () => {
        ...
        setTimeout(() => {
            ...
            imgFront!.src = `/image/Skinned_Akali_${skinIndex}.png`
        }, 500)
    }
    ...
    return (
        <div onMouseMove={trackPointer} className="content_skin">
            ...
            <img className='forest_background_1' src="/image/Forest_1.png" alt="" />
            <img className='forest_background_2' src="/image/Forest_2.png" alt="" />
            <div className="champion_skin">
                <div className="skin_box">
                </div>
                <img id='skin_image_front' src="/image/Skinned_Akali_3.png" alt=""></img>
                <img id='skin_image_back' src="/image/Skinned_Akali_2.png" alt=""></img>
            </div>
